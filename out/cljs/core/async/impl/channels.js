...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16697 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16697 = (function (val,box,meta16698){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16697.cljs$lang$type = true;
cljs.core.async.impl.channels.t16697.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16697";
cljs.core.async.impl.channels.t16697.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.channels/t16697");
});
cljs.core.async.impl.channels.t16697.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16697.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16699){var self__ = this;
var _16699__$1 = this;return self__.meta16698;
});
cljs.core.async.impl.channels.t16697.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16699,meta16698__$1){var self__ = this;
var _16699__$1 = this;return (new cljs.core.async.impl.channels.t16697(self__.val,self__.box,meta16698__$1));
});
cljs.core.async.impl.channels.__GT_t16697 = (function __GT_t16697(val__$1,box__$1,meta16698){return (new cljs.core.async.impl.channels.t16697(val__$1,box__$1,meta16698));
});
}
return (new cljs.core.async.impl.channels.t16697(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_16700 = self__.takes.pop();if((taker_16700 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16700))
{var take_cb_16701 = cljs.core.async.impl.protocols.commit.call(null,taker_16700);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16701,taker_16700){
return (function (){return take_cb_16701.call(null,null);
});})(take_cb_16701,taker_16700))
);
} else
{}
{
