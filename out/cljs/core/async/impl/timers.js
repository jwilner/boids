...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_16668 = 0;while(true){
if((i_16668 < arr.length))
{(arr[i_16668] = null);
{
...
{var i_16675 = (self__.level + 1);while(true){
if((i_16675 <= (new_level + 1)))
{(update[i_16675] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16677 = 0;while(true){
if((i_16677 <= self__.level))
{var links_16678 = (update[i_16677]).forward;if(((links_16678[i_16677]) === x__$1))
{(links_16678[i_16677] = (x__$1.forward[i_16677]));
{
var G__16679 = (i_16677 + 1);
i_16677 = G__16679;
continue;
}
} else
{{
var G__16680 = (i_16677 + 1);
i_16677 = G__16680;
continue;
}
}
